...
// AuditAction constants for v0.7.37 / v0.7.38 collaborative_docs + slides
// surfaces. These are the events emitted by the per-feature audit hooks
// wired from internal/container/container.go.
//
// Scope / Target convention:
//   ScopeType = "collab_doc" | "slide_deck"
//   ScopeID   = doc_id or deck_id (uuid v4)
//   TargetID  = slide_id when applicable (otherwise "")
//
// Details JSON is per-event and lives in types/collaborative_doc.go's
// CollabDocAuditAction helper tables.
const (
	AuditActionCollabDocCreated  AuditAction = "collab_doc.created"
	AuditActionCollabDocUpdated  AuditAction = "collab_doc.updated"
	AuditActionCollabDocArchived AuditAction = "collab_doc.archived"
	AuditActionCollabDocDeleted  AuditAction = "collab_doc.deleted"
	AuditActionCollabDocShared   AuditAction = "collab_doc.shared"
	AuditActionCollabDocUploaded AuditAction = "collab_doc.uploaded"
	AuditActionCollabDocExported AuditAction = "collab_doc.exported"

	AuditActionSlideDeckCreated       AuditAction = "slide_deck.created"
	AuditActionSlideDeckUpdated       AuditAction = "slide_deck.updated"
	AuditActionSlideDeckDeleted       AuditAction = "slide_deck.deleted"
	AuditActionSlideDeckAutoGenerated AuditAction = "slide_deck.auto_generated"
	AuditActionSlideDeckExported      AuditAction = "slide_deck.exported"
)
