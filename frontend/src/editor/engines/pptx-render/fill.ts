 ...
 */
import type { Fill, Stroke, ShadowEffect } from '../pptx-engine/index.ts'
...
export function resolveGlow(
  glow: import('../pptx-engine/index.ts').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('../pptx-engine/index.ts').ReflectionEffect | undefined,
  vp: Viewport,
