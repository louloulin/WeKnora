/**
 * v0.7.49 — DOC comment mark operations (copy from genoffice
 * apps/docs/src/renderer/editor/comments.ts, imports adapted to WeKnora).
 *
...
import type { CommentInfo } from '../engines/docx-engine'
import { Mark } from '@tiptap/core'

/** meta key used by the track-changes recorder to ignore programmatic edits */
