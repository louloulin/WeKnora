/**
 * v0.7.53 — DOC table column sizing (copy from genoffice
 * apps/docs/src/renderer/editor/table-sizing.ts, imports unchanged — the
 * module keys off ProseMirror tableRole, so it works with TipTap's `table`
 * node as-is).
 *
