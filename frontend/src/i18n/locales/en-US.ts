export default {
  ...
  knowledgeBase: {
    ...
    collabDoc: {
      ...
      create: 'New',
      // v0.7.41 — share link password + expiry panel
      share: {
        title: 'Share link',
        hint: 'Anyone with the link can view this document. Add a password or an expiry to gate access.',
        enable: 'Enable share link',
        enabling: 'Enabling…',
        disable: 'Disable share link',
        refresh: 'Update password / expiry',
        ...
        passwordPlaceholder: 'Leave blank for an open link',
        passwordTooShort: 'Password must be at least 6 characters.',
        expiresLabel: 'Expires',
        expiresHint: 'Leave blank for a link that never expires.',
        expiresAt: 'Expires at',
        neverExpires: 'Never expires',
        advanced: 'Advanced (change password / expiry)',
  ...
  agent: {
    library: {
      title: 'Agent library',
      subtitle: 'Browse every available built-in and custom agent in this workspace',
      countLabel: 'agents',
      filterPlaceholder: 'Search agent name / description / creator…',
      ...
      metaTools: '{count} tools',
      metaKbAll: 'All KBs',
      metaKbNone: 'No KB',
      metaKbOne: '1 KB',
      metaKbMany: '{count} KBs',
      startSession: 'Start session',
      edit: 'Edit',
      copy: 'Copy',
      emptyTitle: 'No agents in this workspace yet',
      emptyDesc: 'Create a new agent or start from a template — they will appear here automatically.',
      noMatchTitle: 'No matching agents',
      noMatchDesc: 'Try a different search keyword or clear the filters.',
    },
    taskLabel: 'Task:',
    think: 'Thinking',
    copy: 'Copy',
  ...
  knowledgeEditor: {
    ...
    wikiInlineAI: {
      regionLabel: 'Inline AI actions',
      summarize: 'Summarize',
      summarizeTitle: 'Summarize selection with AI',
      translate: 'Translate',
      translateTitle: 'Translate selection with AI',
      explain: 'Explain',
      explainTitle: 'Explain selection with AI',
      improve: 'Improve',
      improveTitle: 'Improve selection with AI',
      ask: 'Ask',
    ...
    wikiDatabaseView: {
      ...
      filterPlaceholder: 'Search title / summary / properties…',
      typeFilter: 'Filter by type',
      emptyTitle: 'No pages in this knowledge base yet',
      emptyDesc: 'Pages will appear here automatically after you create them or import documents.',
      noMatchTitle: 'No matching pages',
      noMatchDesc: 'Try a different search keyword or clear the filters.',
      viewTable: 'Table',
      viewBoard: 'Board',
      boardGroupBy: 'Group by',
      boardGroupByPlaceholder: 'Choose a property',
    ...
    wiki: {
      ...
      syncBlock: {
        pickerTitle: 'Insert synced block',
        pickerSearchPlaceholder: 'Search blocks…',
        pickerCreateNew: 'Create new',
        pickerEmpty: 'No synced blocks yet. Create one to get started.',
        pickerInsert: 'Insert',
        createDialogTitle: 'New synced block',
        createDialogTitleLabel: 'Title',
        createDialogPlaceholder: 'Block title (optional)',
        createDialogContentLabel: 'Content',
        createDialogSave: 'Save',
        createDialogCancel: 'Cancel',
        badgeSynced: 'Synced',
        toastInserted: 'Synced block inserted',
        toastCreated: 'Synced block created',
        toastDeleted: 'Synced block deleted'
      }
    },
    dockb: {
      databaseTitle: 'Database / Multi-dimensional Table',
      newDatabase: 'New database',
      createTitle: 'New database',
      dbNamePlaceholder: 'Database name, e.g. Product manual',
      dbDescPlaceholder: 'Description (optional)',
      schemaFields: 'Schema',
      ...
      noRows: 'No rows yet.',
      actions: 'actions',
      confirmDeleteDB: 'Delete database {name}? This cannot be undone.',
    },
    connector: {
      title: 'AI Connectors',
    ...
    dlp: {
      ...
      name: 'Policy name',
      namePlaceholder: 'e.g. Customer PII',
      severity: 'Severity',
      action: 'Action',
      resourceScope: 'Scope',
      description: 'Description',
      ...
      manageRules: 'rules',
      rules: 'Rules',
      patternPlaceholder: 'regex or dictionary term',
      tryScan: 'Try a scan',
      scanPlaceholder: 'Paste text here for live sensitive-data detection…',
      scan: 'Scan',
      scannedChars: 'scanned chars',
      duration: 'duration',
      noMatches: 'No sensitive data found.',
    },
    authz: {
      policyTitle: 'AuthZ Policy Manager — versioning + rollback',
      newKeyPlaceholder: 'New policy key, e.g. kb.upload',
      ...
      expressionPlaceholder: 'e.g. actor.role == "editor" && resource.kb == "public"',
      metadata: 'Metadata (JSON)',
      publish: 'Publish',
      versionHistory: 'Version history',
      noVersions: 'No versions yet — publish one.',
      from: 'from',
      to: 'to',
      setFrom: 'set from',
      setTo: 'set to',
      rollback: 'rollback',
      rollbackConfirm: 'Roll back to v{version}? This will publish a new version.',
    ...
    wikiComment: {
      ...
      open: 'Open',
      replies: 'Replies',
      statsLabel: '{open} open · {resolved} resolved',
      empty: 'No comments yet. Be the first to share your thoughts.',
      anchorBadge: 'Anchored to selection',
      tooLong: 'Comment body is too long (max 4 KB)',
      forbiddenEdit: 'Only the comment author can edit this comment',
      forbiddenResolve: 'Only the comment author or a KB admin can resolve this thread',
      forbiddenDelete: 'Only the comment author or a KB admin can delete this comment',
      postBtn: 'Post',
      posting: 'Posting...',
    ...
    wikiBrowser: {
      ...
      newPageTemplateLabel: 'Template',
      newPageTemplateBlank: 'Blank page',
      newPageTemplateMeeting: 'Meeting notes',
      newPageTemplateWeekly: 'Project weekly',
      newPageTemplateManage: 'Manage my templates',
      userTemplate: {
        title: 'Manage custom templates',
        listTitle: 'My templates',
        empty: 'No custom templates yet. Click "Add" to create one.',
        addBtn: 'Add',
        addTitle: 'New custom template',
        editTitle: 'Edit custom template',
        nameLabel: 'Template name',
        namePlaceholder: 'e.g. Customer visit notes',
        nameRequired: 'Template name is required',
        contentLabel: 'Template body (Markdown)',
        contentPlaceholder: 'Markdown body for the template; placeholders / sample data welcome',
      ...
      comments: {
        title: 'Page comments',
        titleFor: 'Comments on "{title}"',
        hint: 'Use {\'@\'} to mention teammates — a candidate list pops up as you type. Comments persist with page revisions.',
        ...
        deleteConfirm: 'Delete the comment from {author}?',
        deleteSuccess: 'Comment deleted',
        editBtn: 'Edit',
        error: {
          empty: 'Comment body cannot be empty',
          tooLong: 'Comment exceeds the 4096-character limit',
          loadFailed: 'Failed to load comments',
      ...
      share: {
        header: 'Share page',
        headerFor: 'Share "{title}"',
        createTitle: 'Create a new share link',
        ...
        expiry30d: '30 days',
        expiryNever: 'Never',
        expiryNeverLabel: 'Never expires',
        expiryRevoked: 'Revoked',
        expiryExpired: 'Expired',
        expiresAt: 'Expires {at}',
        passwordLabel: 'Password (optional)',
        passwordPlaceholder: 'Leave blank for no password',
        passwordChip: 'Password',
        passwordTitle: 'This link is password-protected',
        passwordHint: 'Enter the password the owner set',
        passwordUnlock: 'Unlock',
        passwordWrong: 'Wrong password',
        passwordUnlockFailed: 'Failed to unlock',
        watermarkHint: 'When opened, the page overlays a token-derived watermark to trace screenshots.',
        createBtn: 'Create link',
        createSuccess: 'Link created and copied to clipboard',
        ...
        revokeConfirm: 'The link will stop working immediately. Continue?',
        revokeSuccess: 'Link revoked',
        views: '{count} views',
        lastViewed: 'Last opened {at}',
        publicSubtitle: 'Public share',
        publicSubtitleFor: 'From {kb}',
        publicFooter: 'Last updated: {when} · Type: {type}',
        publicFooterRaw: 'Last updated: {when} · Type: {type}',
        errorLoadTitle: 'Failed to load',
        errorLoadBody: 'Please retry later',
        errorRevokedTitle: 'Link revoked',
        errorRevokedBody: 'The owner revoked this share link',
        errorNotFoundTitle: 'Link not found',
        errorNotFoundBody: 'The link may have been deleted or never existed',
        error: {
          loadFailed: 'Failed to load share links',
      ...
      acl: {
        ...
        modeTitle: 'Access mode',
        mode: {
          inherit: 'Inherit from knowledge base',
          inheritHint: 'Default — follow KB-level access controls',
          private: 'Private',
          privateHint: 'Only the page author and tenant admins',
          allowList: 'Allow list',
          allowListHint: 'On top of KB members, allow designated members',
        },
        allowListTitle: 'Allowed members',
        searchPlaceholder: 'Search by username or email to add',
        searching: 'Searching…',
        searchEmpty: 'No matching users',
        allowListEmpty: 'No members added yet',
      ...
      revisionsDrawer: {
        ...
        empty: 'No revisions yet — a snapshot is recorded automatically when the page changes.',
        ...
        compareSummary: '+{added} - {deleted}',
        diffTruncated: 'Content is too large to render a diff. Open the versions one at a time.',
        noContent: 'This revision has no content',
        revert: 'Revert to this version',
        revertConfirmTitle: 'Confirm revert',
        revertConfirm: 'Revert to v{version}? The current content will be saved as a new version first; this revert can itself be undone.',
        revertSuccess: 'Reverted to v{version}',
        revertError: 'Revert failed',
      },
      // Build #12 — wiki page bulk actions i18n keys
      bulkSelect: 'Select',
      bulkBar: '{count} selected',
      bulkMove: 'Move',
      bulkMoveDialogTitle: 'Move pages',
      bulkMoveDialogHint: 'Pick a destination folder. The selected {count} pages will all be moved into it.',
      bulkMoveSelectFolder: 'Select destination folder',
      bulkMoveConfirm: 'Move',
      bulkMoveSuccess: 'Moved {count} pages',
      bulkMovePartial: 'Moved {succeeded}, failed {failed}',
      bulkMoveFailed: 'Bulk move failed: {error}',
      bulkMoveLoadFoldersFailed: 'Failed to load folders, please retry',
      bulkStatus: 'Status',
      bulkStatusSuccess: 'Updated status of {count} pages',
      bulkStatusPartial: 'Updated {succeeded}, failed {failed}',
      bulkStatusFailed: 'Bulk status update failed: {error}',
      bulkDelete: 'Delete',
      bulkDeleteDialogTitle: 'Delete pages',
      bulkDeleteDialogHint: 'Delete the selected {count} pages? This action cannot be undone.',
      bulkDeleteConfirm: 'Delete',
      bulkDeleteSuccess: 'Deleted {count} pages',
      ...
      bulkJobUndoing: 'Undoing…',
      bulkJobUndoSucceeded: 'Undone',
      ...
      batch: {
        error: {
          notFound: 'Page does not exist or has been deleted',
          folderNotFound: 'Destination folder does not exist',
          folderConflict: 'Folder name conflict',
          folderNotEmpty: 'Destination folder is not empty',
          kbMismatch: 'Page does not belong to this knowledge base',
          internal: 'Internal server error',
        },
        // Build #14 — wiki bulk-operation audit log UI
        audit: {
          toolbarBtn: 'Audit log',
          jobDrawerTitle: 'Audit trail for job {id}',
          kbDrawerTitle: 'Bulk operation audit log',
      ...
      syncBlock: {
        title: 'Synced Blocks',
        description: 'Reusable content units — edit once, every reference updates automatically. Matches Notion Synced Blocks and 飞书同步块.',
        pickerTitle: 'Insert synced block',
        pickerSearchPlaceholder: 'Search blocks by title…',
        pickerEmpty: 'No synced blocks yet — create your first one to get started.',
        pickerCreateBtn: 'Create new block',
        createBtn: 'Create synced block',
        createDialogTitle: 'Create synced block',
        editDialogTitle: 'Edit synced block',
        deleteBtn: 'Delete',
        deleteConfirm: 'Delete this synced block? Embedded copies will be unlinked from {count} page(s) but their content stays intact.',
        deleteCascade: 'Delete and remove from all pages',
        deleteUnlink: 'Delete and unlink from pages (keep content)',
        fieldTitleLabel: 'Block title',
        fieldTitlePlaceholder: 'e.g. Company holiday policy',
        fieldContentLabel: 'Block content',
        fieldContentHint: 'Edit in the embedded editor. Markdown is auto-generated for search indexing.',
        saveSuccess: 'Synced block saved',
        saveFailed: 'Failed to save synced block',
        loadFailed: 'Failed to load synced block',
        deleteSuccess: 'Synced block deleted',
        deleteFailed: 'Failed to delete synced block',
        refBadge: 'Used in {count} page(s)',
        refBadgeSingle: 'Used in 1 page',
        staleBadge: 'Needs refresh',
        refreshBtn: 'Refresh from source',
        editSourceBtn: 'Edit source block',
        contentVersionLabel: 'Version {version}',
        anchorLabel: 'Anchor: {slug}',
        errorNotFound: 'Synced block not found or has been deleted',
        errorForbidden: 'You do not have permission to access this synced block',
      customAgent: {
        studioTitle: 'Agent Studio — {name}',
        runNow: 'Run now',
        tabTriggers: 'Triggers',
        tabRuns: 'Runs',
        tabCredentials: 'Credentials',
        triggerNamePlaceholder: 'Trigger name (unique per agent)',
        triggerCron: 'Cron',
        triggerEvent: 'Event',
        triggerWebhook: 'Webhook',
        triggerManual: 'Manual',
        triggerConfigPlaceholder: 'JSON config (e.g. {"cron":"0 9 * * *"} )',
        ...
        noTriggers: 'No triggers yet — add one above.',
        noRuns: 'No runs yet — click Run now to start.',
        noCredentials: 'No credentials yet — add one above.',
        pause: 'Pause',
        resume: 'Resume',
        delete: 'Delete',
        credNamePlaceholder: 'Credential name',
        credSecretPlaceholder: 'Secret value (encrypted at rest)',
  ...
  wiki: {
    ...
    tags: {
      ...
      add: 'Add tag',
      remove: 'Remove',
      selectPlaceholder: 'Search tags…',
      empty: 'No tags yet — create one with the button above',
      emptyHint: 'Tags group pages so bulk operations touch them all at once',
      pageEmpty: 'No tags on this page',
      bulkBar: '{count} page(s) selected — add or remove a tag',
      bulkSelectTag: 'Select tag',
      bulkAdd: 'Bulk add',
      bulkRemove: 'Bulk remove',
      bulkNoTags: 'Create tags in the sidebar first',
      bulkAddSuccess: 'Tag added in bulk',
      bulkRemoveSuccess: 'Tag removed in bulk',
      bulkPartial: 'Some pages failed',
      dialog: {
        createTitle: 'New tag',
        editTitle: 'Edit tag · {name}',
        nameLabel: 'Name',
        namePlaceholder: 'e.g. todo / arch / wip',
        colorLabel: 'Color',
        save: 'Save',
        cancel: 'Cancel',
      ...
      error: {
        ...
        limitReached: 'A page can have at most 10 tags',
        selectFirst: 'Pick a tag first',
        createFailed: 'Tag creation failed',
        updateFailed: 'Tag update failed',
        deleteFailed: 'Tag deletion failed',
        saveFailed: 'Save failed · {detail}',
        batchFailed: 'Bulk operation failed · {detail}',
      },
    },
    template: {
      toolbarBtn: 'Apply template skeleton',
      title: 'Apply template skeleton · {parent}',
      hint: 'Placeholder tokens (child_pages, child_section, tagged_pages:foo) will expand when you apply. Fill in concrete content before applying.',
      children: 'Child pages',
      addChild: 'Add child',
      noChildren: 'No child pages added yet',
      sections: 'Child sections',
      addSection: 'Add section',
      noSections: 'No child sections added yet',
      childTitle: 'Child page title',
      childContent: 'Child page body (optional)',
      sectionTitle: 'Section title',
      sectionBody: 'Section body',
      taggedTokens: 'Tagged pages',
      taggedTokensPlaceholder: 'tag1, tag2, ...',
      taggedTokensHint: 'Comma-, space- or newline-separated tag names. Placeholders of the form tagged_pages:foo expand into the page list for each tag.',
      preview: 'Preview expanded body',
      previewButton: 'Preview',
      previewEmpty: 'Click Preview to see the expanded body before applying.',
