export default {
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      syncBlock: {
    "picker.title": "Insert synced block",
    "picker.searchPlaceholder": "Search blocks…",
    "picker.createNew": "Create new",
    "picker.empty": "No synced blocks yet. Create one to get started.",
    "picker.insert": "Insert",
    "createDialog.title": "New synced block",
    "createDialog.titleLabel": "Title",
    "createDialog.placeholder": "Block title (optional)",
    "createDialog.contentLabel": "Content",
    "createDialog.save": "Save",
    "createDialog.cancel": "Cancel",
    "badge.synced": "Synced",
    "toast.inserted": "Synced block inserted",
    "toast.created": "Synced block created",
    "toast.deleted": "Synced block deleted"
  },
},
    indexing: {
