export default {
  ...
  knowledgeEditor: {
    ...
    wikiInlineAI: {
      regionLabel: '行内 AI 操作',
      summarize: '总结',
      summarizeTitle: '用 AI 总结选中内容',
      translate: '翻译',
      translateTitle: '用 AI 翻译选中内容',
      explain: '解释',
      explainTitle: '用 AI 解释选中内容',
      improve: '润色',
      improveTitle: '用 AI 改进选中内容',
      ask: '提问',
    ...
    wikiDatabaseView: {
      ...
      filterPlaceholder: '搜索标题 / 摘要 / 属性…',
      typeFilter: '按类型筛选',
      emptyTitle: '此知识库还没有页面',
      emptyDesc: '新建页面或导入文档后,它们会自动出现在表格中。',
      noMatchTitle: '没有匹配的页面',
      noMatchDesc: '尝试调整搜索关键词或清空筛选条件。',
      viewTable: '表格',
      viewBoard: '看板',
      boardGroupBy: '按',
      boardGroupByPlaceholder: '选择分组字段',
      boardEmpty: '当前页面集合中还没有可作为分组轴的属性。',
      boardColEmpty: '无',
      boardUngrouped: '未分组',
          viewCalendar: '日历',
      calendarDateLabel: '日期字段:',
      calendarDatePlaceholder: '选择日期属性',
      calendarEmpty: '请在上方选择日期属性以填充日历。',
      calendarMore: '更多',
    },
    titleCreate: '新建知识库',
    titleEdit: '知识库设置',
    ...
    wikiComment: {
      ...
      edit: '编辑',
      delete: '删除',
      confirmDelete: '确定删除该评论吗？此操作不可撤销。',
      resolved: '已解决',
      open: '未解决',
      replies: '条回复',
      statsLabel: '{open} 条未解决 · {resolved} 条已解决',
      empty: '还没有评论，欢迎发表第一条。',
      anchorBadge: '已锚定到选中块',
      tooLong: '评论内容过长（最大 4 KB）',
      forbiddenEdit: '只有评论作者本人可以编辑',
      forbiddenResolve: '只有评论作者或知识库管理员可以解决该讨论',
      forbiddenDelete: '只有评论作者或知识库管理员可以删除该评论',
      postBtn: '发表',
      posting: '正在发表...',
      loadFailed: '加载评论失败'
    },
    ...
    wikiBrowser: {
      ...
      newPageTemplateLabel: '页面模板',
      newPageTemplateBlank: '空白页面',
      newPageTemplateMeeting: '会议纪要',
      newPageTemplateWeekly: '项目周报',
      newPageTemplateManage: '管理我的模板',
      userTemplate: {
        title: '管理自定义模板',
        listTitle: '我的模板',
        empty: '尚未创建自定义模板。点击「新建」开始。',
        addBtn: '新建',
        addTitle: '新建自定义模板',
        editTitle: '编辑自定义模板',
        nameLabel: '模板名称',
        namePlaceholder: '例如：客户拜访记录',
        nameRequired: '请填写模板名称',
        contentLabel: '模板内容（Markdown）',
        contentPlaceholder: '使用 Markdown 编写模板正文，可包含占位符或示例数据',
        createSuccess: '模板已创建',
        updateSuccess: '模板已更新',
        deleteTitle: '删除模板',
        deleteConfirm: '确定删除模板「{name}」吗？此操作不可撤销。',
        deleteSuccess: '模板已删除',
        sectionTitle: '我的模板',
      },
      commentsBtn: '评论',
      comments: {
        title: '页面评论',
        titleFor: '「{title}」的评论',
        hint: '支持 {\'@\'}提及 协作者，输入 {\'@\'} 弹出候选列表。评论会随版本记录保留。',
        empty: '暂无评论，写下第一条吧。',
        submit: '发表',
        ...
        updateSuccess: '评论已更新',
        deleteTitle: '删除评论',
        deleteConfirm: '确定删除 {author} 的这条评论吗？',
        deleteSuccess: '评论已删除',
        editBtn: '编辑',
        error: {
          empty: '评论内容不能为空',
          tooLong: '评论内容超过长度上限（4096 字符）',
          loadFailed: '加载评论失败',
          createFailed: '发表评论失败',
          updateFailed: '更新评论失败',
          deleteFailed: '删除评论失败',
      ...
      share: {
        ...
        expiry30d: '30 天',
        expiryNever: '永不过期',
        expiryNeverLabel: '永不过期',
        expiryRevoked: '已撤销',
        expiryExpired: '已过期',
        expiresAt: '过期时间：{at}',
        passwordLabel: '访问密码（可选）',
        passwordPlaceholder: '留空表示不需要密码',
        passwordChip: '需密码',
        passwordTitle: '此分享链接受密码保护',
        passwordHint: '请输入链接所有者设置的访问密码',
        passwordUnlock: '解锁',
        passwordWrong: '密码不正确',
        passwordUnlockFailed: '解锁失败',
        watermarkHint: '链接打开时，页面会自动叠加水印，便于追溯截图来源。',
        createBtn: '创建链接',
        createSuccess: '链接已创建并复制到剪贴板',
        empty: '还没有任何分享链接',
        copyBtn: '复制',
        copySuccess: '链接已复制',
        copyFallback: '请手动复制以下链接',
        revokeBtn: '撤销',
        revokeTitle: '撤销分享链接',
        revokeConfirm: '撤销后链接将立即失效，确定吗？',
        revokeSuccess: '链接已撤销',
        views: '访问 {count} 次',
        lastViewed: '最近 {at}',
        publicSubtitle: '公开分享',
        publicSubtitleFor: '来自 {kb}',
        publicFooter: '最后更新：{when} · 类型：{type}',
        publicFooterRaw: '最后更新：{when} · 类型：{type}',
        errorLoadTitle: '加载失败',
        errorLoadBody: '请稍后重试',
        errorRevokedTitle: '链接已失效',
        errorRevokedBody: '此分享链接已被所有者撤销',
        errorNotFoundTitle: '链接不存在',
        errorNotFoundBody: '链接可能已被删除或从未存在',
        error: {
          loadFailed: '加载分享链接失败',
      ...
      acl: {
        ...
        mode: {
          inherit: '继承知识库',
          inheritHint: '默认行为，遵循知识库级别的访问控制',
          private: '私有',
          privateHint: '仅页面作者和租户管理员可访问',
          allowList: '指定名单',
          allowListHint: '在知识库成员基础上，额外允许指定成员',
        },
        allowListTitle: '允许访问的成员',
        searchPlaceholder: '搜索用户名或邮箱以添加',
        searching: '正在搜索…',
        searchEmpty: '未找到匹配用户',
        allowListEmpty: '尚未添加任何成员',
      ...
      revisionsDrawer: {
        ...
        diffTruncated: '内容过长，已停止渲染差异。请分段查看。',
        noContent: '该版本没有内容',
        revert: '回滚到此版本',
        revertConfirmTitle: '回滚确认',
        revertConfirm: '确定回滚到 v{version} 吗？当前内容会先保存为新版本，回滚操作可再次撤销。',
        revertSuccess: '已回滚到 v{version}',
        revertError: '回滚失败',
      },
      // Build #12 — wiki 页面批量操作 i18n keys
      bulkSelect: '多选',
      bulkBar: '已选 {count} 页',
      bulkMove: '移动',
      bulkMoveDialogTitle: '批量移动页面',
      bulkMoveDialogHint: '选择目标文件夹；所选 {count} 页将被同时移入该文件夹。',
      bulkMoveSelectFolder: '选择目标文件夹',
      bulkMoveConfirm: '移动',
      bulkMoveSuccess: '已移动 {count} 页',
      bulkMovePartial: '已移动 {succeeded} 页，{failed} 页失败',
      bulkMoveFailed: '批量移动失败：{error}',
      bulkMoveLoadFoldersFailed: '加载文件夹列表失败，请稍后重试',
      bulkStatus: '状态',
      bulkStatusSuccess: '已更新 {count} 页状态',
      bulkStatusPartial: '已更新 {succeeded} 页，{failed} 页失败',
      bulkStatusFailed: '批量更新状态失败：{error}',
      bulkDelete: '删除',
      bulkDeleteDialogTitle: '批量删除页面',
      bulkDeleteDialogHint: '确定要删除所选 {count} 页吗？此操作不可撤销。',
      bulkDeleteConfirm: '删除',
      bulkDeleteSuccess: '已删除 {count} 页',
      ...
      syncBlock: {
        title: '同步块',
        description: '可复用的内容单元——一处修改，所有引用自动同步更新。对标 Notion Synced Blocks 与飞书同步块。',
        pickerTitle: '插入同步块',
        pickerSearchPlaceholder: '按标题搜索同步块…',
        pickerEmpty: '暂无同步块，点击下方按钮创建第一个吧。',
        pickerCreateBtn: '创建新同步块',
        createBtn: '创建同步块',
        createDialogTitle: '创建同步块',
        editDialogTitle: '编辑同步块',
        deleteBtn: '删除',
        deleteConfirm: '确定删除此同步块？嵌入它的 {count} 个页面将自动解除引用，但内容保留。',
        deleteCascade: '删除并从所有页面移除',
        deleteUnlink: '删除并解除引用（保留页面内容）',
        fieldTitleLabel: '同步块标题',
        fieldTitlePlaceholder: '例如：公司假期政策',
        fieldContentLabel: '同步块内容',
        fieldContentHint: '在嵌入的编辑器中编辑。Markdown 会自动生成，用于搜索索引。',
        saveSuccess: '同步块已保存',
        saveFailed: '同步块保存失败',
        loadFailed: '同步块加载失败',
        deleteSuccess: '同步块已删除',
        deleteFailed: '同步块删除失败',
        refBadge: '已被 {count} 个页面引用',
        refBadgeSingle: '已被 1 个页面引用',
        staleBadge: '需要刷新',
        refreshBtn: '从源刷新',
        editSourceBtn: '编辑源同步块',
        contentVersionLabel: '版本 {version}',
        anchorLabel: '锚点：{slug}',
        errorNotFound: '同步块不存在或已被删除',
        errorForbidden: '您没有访问此同步块的权限',
      customAgent: {
        studioTitle: '智能体工作室 — {name}',
        runNow: '立即运行',
        tabTriggers: '触发器',
        tabRuns: '运行历史',
        tabCredentials: '凭据库',
        triggerNamePlaceholder: '触发器名称（同一智能体下唯一）',
        triggerCron: '定时',
        triggerEvent: '事件',
        triggerWebhook: 'Webhook',
        triggerManual: '手动',
        triggerConfigPlaceholder: 'JSON 配置（如 {"cron":"0 9 * * *"}）',
        addTrigger: '添加触发器',
        colName: '名称',
        colType: '类型',
        colStatus: '状态',
        ...
        colExpires: '到期时间',
        colLastUsed: '上次使用',
        noTriggers: '暂无触发器，请在上方添加。',
        noRuns: '暂无运行记录，点击"立即运行"开始。',
        noCredentials: '暂无凭据，请在上方添加。',
        pause: '暂停',
        resume: '恢复',
        delete: '删除',
        credNamePlaceholder: '凭据名称',
        credSecretPlaceholder: '密钥内容（加密存储）',
        addCredential: '添加凭据',
      },
      },
    },
    ...
    dlp: {
      editorTitle: 'DLP 策略编辑器 — 敏感数据防护',
      createPolicy: '新建策略',
      name: '策略名称',
      namePlaceholder: '例如：客户隐私数据',
      severity: '严重等级',
      action: '处置动作',
      resourceScope: '作用范围',
      description: '说明',
      ...
      manageRules: '管理规则',
      rules: '规则',
      patternPlaceholder: '输入正则表达式或字典词',
      tryScan: '试扫描',
      scanPlaceholder: '在此粘贴文本，实时检测敏感数据…',
      scan: '扫描',
      scannedChars: '扫描字符数',
      duration: '耗时',
      noMatches: '未发现敏感数据。',
    ...
    authz: {
      policyTitle: 'AuthZ 策略管理 — 版本化与回滚',
      newKeyPlaceholder: '新策略 Key，例如 kb.upload',
      newPolicy: '新建策略',
      policies: '策略',
      noPolicies: '暂无策略，请新建。',
      viewHistory: '查看历史',
      ...
      decision: '决策',
      expression: '表达式',
      expressionPlaceholder: '例如：actor.role == "editor" && resource.kb == "public"',
      metadata: '元数据 (JSON)',
      publish: '发布',
      versionHistory: '版本历史',
      noVersions: '暂无版本，请发布。',
      ...
      setTo: '设为对照',
      rollback: '回滚',
      rollbackConfirm: '确定回滚到 v{version} 吗？此操作会发布新版本。',
    ...
    dockb: {
      databaseTitle: '数据库 / 多维表',
      newDatabase: '新建数据库',
      createTitle: '新建数据库',
      dbNamePlaceholder: '数据库名称，例如：产品手册',
      dbDescPlaceholder: '说明（可选）',
      schemaFields: '字段定义',
      fieldNamePlaceholder: '字段名',
      optionsPlaceholder: '选项，逗号分隔',
      addField: '字段',
      cancel: '取消',
      submit: '提交',
      databases: '数据库',
      noDatabases: '暂无数据库，请新建。',
      fields: '字段',
      open: '打开',
      delete: '删除',
      noRows: '暂无数据。',
      actions: '操作',
      confirmDeleteDB: '确定删除数据库 {name} 吗？此操作不可撤销。',
    },
    indexing: {
      title: '索引策略',
    ...
    wiki: {
      ...
      syncBlock: {
        pickerTitle: '插入同步块',
        pickerSearchPlaceholder: '搜索同步块…',
        pickerCreateNew: '新建同步块',
        pickerEmpty: '尚无同步块。点击右上角创建一个。',
        pickerInsert: '插入',
        createDialogTitle: '新建同步块',
        createDialogTitleLabel: '标题',
        createDialogPlaceholder: '同步块标题（可留空）',
        createDialogContentLabel: '内容',
        createDialogSave: '保存',
        createDialogCancel: '取消',
        badgeSynced: '同步块',
        toastInserted: '同步块已插入',
        toastCreated: '同步块已创建',
        toastDeleted: '同步块已删除'
      }
    },
  ...
  agent: {
    library: {
      title: 'Agent 库',
      subtitle: '在工作区内浏览所有可用的内置与自定义 Agent',
      countLabel: '个 Agent',
      filterPlaceholder: '搜索 Agent 名称 / 描述 / 创建者…',
      filterByType: '按类型筛选',
      filterByMode: '按模式筛选',
      filterBySource: '按来源筛选',
      modeQuickAnswer: '快速问答',
      modeSmartReasoning: '智能推理',
      sourceBuiltin: '内置',
      sourceCustom: '自定义',
      badgeBuiltin: '内置',
      metaTools: '{count} 个工具',
      ...
      metaKbNone: '未选 KB',
      metaKbOne: '1 个 KB',
      metaKbMany: '{count} 个 KB',
      startSession: '开始会话',
      edit: '编辑',
      copy: '复制',
      emptyTitle: '工作区还没有 Agent',
      emptyDesc: '新建一个 Agent 或从模板开始,它们会自动出现在这里。',
  ...
  knowledgeStages: {
    ...
    justNow: '刚刚',
    secondsAgo: '{n} 秒前',
    minutesAgo: '{n} 分钟前',    hoursAgo: '{n} 小时前',
    daysAgo: '{n} 天前',
  ...
  knowledgeBase: {
    ...
    collabDoc: {
      ...
      share: {
        title: '分享链接',
        hint: '任何持有链接的人都可以查看此文档。添加密码或过期时间以限制访问。',
        enable: '启用分享链接',
        enabling: '启用中…',
        disable: '禁用分享链接',
        refresh: '更新密码 / 过期时间',
  ...
  wiki: {
    ...
    tags: {
      ...
      add: '添加标签',
      remove: '移除',
      selectPlaceholder: '搜索标签…',
      empty: '还没有标签,点击上方按钮创建一个吧',
      emptyHint: '标签用于给页面分组,可在批量操作时统一处理',
      pageEmpty: '尚未为页面添加标签',
      bulkBar: '已选 {count} 个页面 — 添加/移除标签',
      bulkSelectTag: '选择标签',
      bulkAdd: '批量添加',
      bulkRemove: '批量移除',
      bulkNoTags: '请先在侧边栏创建标签',
      bulkAddSuccess: '已批量添加标签',
      bulkRemoveSuccess: '已批量移除标签',
      bulkPartial: '部分页面处理失败',
      dialog: {
        createTitle: '新建标签',
        editTitle: '编辑标签 · {name}',
        nameLabel: '名称',
        namePlaceholder: '如 todo / arch / wip',
        colorLabel: '颜色',
        save: '保存',
        cancel: '取消',
        createSuccess: '标签已创建',
      ...
      error: {
        nameEmpty: '名称不能为空',
        nameTooLong: '名称不能超过 64 字符',
        limitReached: '单个页面最多 10 个标签',
        selectFirst: '请先选择一个标签',
        createFailed: '标签创建失败',
        updateFailed: '标签更新失败',
        deleteFailed: '标签删除失败',
        saveFailed: '保存失败 · {detail}',
        batchFailed: '批量操作失败 · {detail}',
      },
    },
    template: {
      toolbarBtn: '应用模板骨架',
      title: '应用模板骨架 · {parent}',
      hint: '子页面/子章节占位符会在应用时被自动展开,请填写具体内容后再应用。',
      children: '子页面',
      addChild: '子页面',
      noChildren: '尚未添加子页面',
      sections: '子章节',
      ...
      noSections: '尚未添加子章节',
      childTitle: '子页面标题',
      childContent: '子页面正文(可选)',
      sectionTitle: '子章节标题',
      sectionBody: '子章节正文',
      taggedTokens: '已加标签的页面',
      taggedTokensPlaceholder: 'tag1, tag2, ...',
      taggedTokensHint: '每行/逗号/空格分隔一个标签名,模板中形如 tagged_pages:foo 的占位符会自动展开为该标签下的页面列表。',
      preview: '预览展开后的正文',
      previewButton: '预览',
      previewEmpty: '点击预览查看应用后的正文',
      previewOk: '已生成预览',
      previewFailed: '预览失败 · {error}',
      apply: '应用',
      applyOk: '已生成 {count} 个新页面',
      applyFailed: '应用失败 · {error}',
      emptySkeleton: '请至少添加一个子页面或子章节',
    }
  },
  menu: {
    knowledgeBase: '知识库',
