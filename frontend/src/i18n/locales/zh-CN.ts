export default {
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      syncBlock: {
    "picker.title": "插入同步块",
    "picker.searchPlaceholder": "搜索同步块…",
    "picker.createNew": "新建同步块",
    "picker.empty": "尚无同步块。点击右上角创建一个。",
    "picker.insert": "插入",
    "createDialog.title": "新建同步块",
    "createDialog.titleLabel": "标题",
    "createDialog.placeholder": "同步块标题（可留空）",
    "createDialog.contentLabel": "内容",
    "createDialog.save": "保存",
    "createDialog.cancel": "取消",
    "badge.synced": "同步块",
    "toast.inserted": "同步块已插入",
    "toast.created": "同步块已创建",
    "toast.deleted": "同步块已删除"
  },
},
    basic: {
      title: '基本信息',
