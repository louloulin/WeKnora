export default {
  ...
  datasource: {
    ...
    connector: {
      ...
      newConnector: '새 커넥터',
      createTitle: '커넥터 생성',
      namePlaceholder: '커넥터 이름 (예: slack-prod)',
      configPlaceholder: '커넥터별 JSON 설정',
      kbIdPlaceholder: '대상 지식베이스 ID',
      cancel: '취소',
      submit: '생성',
      noConnectors: '아직 커넥터가 없습니다. "새 커넥터"를 클릭해 추가하세요.',
      enabled: '활성화됨',
      disabled: '비활성화됨',
      lastSync: '마지막 동기화',
      syncNow: '지금 동기화',
      ...
      ingested: '수집됨',
      lastError: '마지막 오류',
      confirmDelete: '커넥터 "{name}"을(를) 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
      kinds: {
        slack: 'Slack',
        email: '이메일',
        webhook: 'Webhook',
  ...
  knowledgeEditor: {
    ...
    wikiInlineAI: {
      regionLabel: '인라인 AI 작업',
      summarize: '요약',
      summarizeTitle: '선택 영역을 AI로 요약',
      translate: '번역',
      translateTitle: '선택 영역을 AI로 번역',
      explain: '설명',
      explainTitle: '선택 영역을 AI로 설명',
      improve: '다듬기',
      improveTitle: '선택 영역을 AI로 개선',
      ask: '질문',
    ...
    wikiDatabaseView: {
      ...
      filterPlaceholder: '제목 / 요약 / 속성 검색…',
      typeFilter: '유형별 필터',
      emptyTitle: '이 지식 베이스에 아직 페이지가 없습니다',
      emptyDesc: '페이지를 만들거나 문서를 가져온 후 자동으로 여기에 표시됩니다.',
      noMatchTitle: '일치하는 페이지가 없습니다',
      noMatchDesc: '다른 검색어를 시도하거나 필터를 지워보세요.',
      viewTable: '테이블',
      viewBoard: '보드',
      boardGroupBy: '그룹 기준',
      boardGroupByPlaceholder: '속성 선택',
      boardEmpty: '현재 페이지 집합에 그룹으로 사용할 속성이 없습니다.',
      boardColEmpty: '비어 있음',
      boardUngrouped: '미분류',
          viewCalendar: '달력',
      calendarDateLabel: '날짜 필드:',
      calendarDatePlaceholder: '날짜 속성 선택',
      calendarEmpty: '달력을 채우려면 위에서 날짜 속성을 선택하세요.',
      calendarMore: '더보기',
    },
    ...
    wikiBrowser: {
      ...
      newPageTemplateLabel: '페이지 템플릿',
      newPageTemplateBlank: '빈 페이지',
      newPageTemplateMeeting: '회의록',
      newPageTemplateWeekly: '프로젝트 위클리',
      newPageTemplateManage: '내 템플릿 관리',
      userTemplate: {
        title: '사용자 정의 템플릿 관리',
        listTitle: '내 템플릿',
        empty: '아직 사용자 정의 템플릿이 없습니다. "추가"를 클릭해 시작하세요.',
        addBtn: '추가',
        addTitle: '새 사용자 정의 템플릿',
        editTitle: '사용자 정의 템플릿 편집',
        nameLabel: '템플릿 이름',
        namePlaceholder: '예: 고객 방문 기록',
        nameRequired: '템플릿 이름을 입력하세요',
        contentLabel: '템플릿 본문 (Markdown)',
        contentPlaceholder: 'Markdown으로 템플릿 본문을 작성하세요. 자리표시자나 샘플 데이터 포함 가능',
        createSuccess: '템플릿이 생성되었습니다',
        updateSuccess: '템플릿이 업데이트되었습니다',
        deleteTitle: '템플릿 삭제',
        deleteConfirm: '"{name}" 템플릿을 삭제하시겠습니까? 되돌릴 수 없습니다.',
      ...
      comments: {
        title: '페이지 댓글',
        titleFor: '"{title}"의 댓글',
        hint: '{\'@\'} 입력으로 동료를 언급할 수 있습니다. 후보 목록이 자동으로 표시됩니다. 댓글은 페이지 버전 기록과 함께 보존됩니다.',
        empty: '아직 댓글이 없습니다. 첫 댓글을 작성해보세요.',
        submit: '게시',
        placeholder: '생각이나 질문을 적어보세요…',
        createSuccess: '댓글이 게시되었습니다',
        updateSuccess: '댓글이 업데이트되었습니다',
        deleteTitle: '댓글 삭제',
        deleteConfirm: '{author}의 댓글을 삭제하시겠습니까?',
        deleteSuccess: '댓글이 삭제되었습니다',
        editBtn: '편집',
        error: {
          empty: '댓글 내용이 비어 있을 수 없습니다',
          tooLong: '댓글이 4096자 제한을 초과했습니다',
          loadFailed: '댓글을 불러오지 못했습니다',
          createFailed: '댓글 게시에 실패했습니다',
          updateFailed: '댓글 업데이트에 실패했습니다',
      ...
      share: {
        ...
        expiry30d: '30일',
        expiryNever: '무제한',
        expiryNeverLabel: '만료 없음',
        expiryRevoked: '취소됨',
        expiryExpired: '만료됨',
        expiresAt: '{at}에 만료',
        passwordLabel: '비밀번호 (선택)',
        passwordPlaceholder: '비밀번호 없이 사용하려면 비워두세요',
        passwordChip: '비밀번호',
        passwordTitle: '이 링크는 비밀번호로 보호됩니다',
        passwordHint: '소유자가 설정한 비밀번호를 입력하세요',
        passwordUnlock: '잠금 해제',
        passwordWrong: '비밀번호가 올바르지 않습니다',
        passwordUnlockFailed: '잠금 해제 실패',
        watermarkHint: '링크를 열면 페이지에 토큰 기반 워터마크가 자동으로 표시되어 스크린샷을 추적할 수 있습니다.',
        createBtn: '링크 만들기',
        createSuccess: '링크가 생성되어 클립보드에 복사되었습니다',
        empty: '공유 링크가 아직 없습니다',
        copyBtn: '복사',
        copySuccess: '링크가 복사되었습니다',
        copyFallback: '이 링크를 수동으로 복사하세요',
        revokeBtn: '취소',
        revokeTitle: '공유 링크 취소',
        revokeConfirm: '링크가 즉시 비활성화됩니다. 계속하시겠습니까?',
        revokeSuccess: '링크가 취소되었습니다',
        views: '조회 {count}회',
        lastViewed: '마지막 열람 {at}',
        publicSubtitle: '공개 공유',
        publicSubtitleFor: '{kb}에서',
        publicFooter: '마지막 업데이트: {when} · 유형: {type}',
        publicFooterRaw: '마지막 업데이트: {when} · 유형: {type}',
        errorLoadTitle: '불러오기 실패',
        errorLoadBody: '잠시 후 다시 시도해 주세요',
        errorRevokedTitle: '링크가 취소되었습니다',
        errorRevokedBody: '소유자가 이 공유 링크를 취소했습니다',
        errorNotFoundTitle: '링크를 찾을 수 없습니다',
        errorNotFoundBody: '링크가 삭제되었거나 존재하지 않을 수 있습니다',
        error: {
          loadFailed: '공유 링크를 불러오지 못했습니다',
          createFailed: '공유 링크 생성에 실패했습니다',
          revokeFailed: '공유 링크 취소에 실패했습니다',
        },
      },
      aclBtn: '권한',
      ...
      acl: {
        ...
        mode: {
          inherit: '지식 베이스에서 상속',
          inheritHint: '기본 — 지식 베이스 접근 제어를 따릅니다',
          private: '비공개',
          privateHint: '페이지 작성자와 테넌트 관리자만 접근 가능',
          allowList: '지정 목록',
          allowListHint: '지식 베이스 멤버 위에 지정된 멤버 허용',
        },
        allowListTitle: '허용된 멤버',
        searchPlaceholder: '사용자 이름 또는 이메일로 검색하여 추가',
        searching: '검색 중…',
        searchEmpty: '일치하는 사용자가 없습니다',
        allowListEmpty: '아직 추가된 멤버가 없습니다',
      ...
      revisionsDrawer: {
        ...
        error: '불러오기 실패',
        empty: '아직 기록된 버전이 없습니다. 페이지가 변경되면 자동으로 스냅샷이 생성됩니다.',
        currentBadge: '현재',
        editedBy: '편집자',
        justNow: '방금 전',
        ...
        yearsAgo: '{count}년 전',
        selectToCompare: '비교에 추가',
        clearCompare: '비교 해제',
        compareSummary: '+{added} -{deleted}',
        diffTruncated: '내용이 너무 길어 차이점을 표시할 수 없습니다. 버전을 하나씩 열어 확인하세요.',
        noContent: '이 버전에는 내용이 없습니다',
        revert: '이 버전으로 되돌리기',
        revertConfirmTitle: '되돌리기 확인',
        revertConfirm: 'v{version}(으)로 되돌릴까요? 현재 내용은 새 버전으로 먼저 저장되며 이 되돌리기 작업은 다시 취소할 수 있습니다.',
        revertSuccess: 'v{version}(으)로 되돌렸습니다',
        revertError: '되돌리기 실패',
      },
      // Build #12 — wiki 페이지 일괄 작업 i18n 키
      bulkSelect: '선택',
      bulkBar: '{count}개 선택됨',
      bulkMove: '이동',
      bulkMoveDialogTitle: '페이지 일괄 이동',
      bulkMoveDialogHint: '대상 폴더를 선택하세요. 선택한 {count}개 페이지가 모두 해당 폴더로 이동됩니다.',
      bulkMoveSelectFolder: '대상 폴더 선택',
      bulkMoveConfirm: '이동',
      bulkMoveSuccess: '{count}개 페이지를 이동했습니다',
      bulkMovePartial: '{succeeded}개 이동, {failed}개 실패',
      bulkMoveFailed: '일괄 이동 실패: {error}',
      bulkMoveLoadFoldersFailed: '폴더 목록을 불러오지 못했습니다',
      bulkStatus: '상태',
      bulkStatusSuccess: '{count}개 페이지 상태를 변경했습니다',
      bulkStatusPartial: '{succeeded}개 변경, {failed}개 실패',
      bulkStatusFailed: '일괄 상태 변경 실패: {error}',
      bulkDelete: '삭제',
      bulkDeleteDialogTitle: '페이지 일괄 삭제',
      bulkDeleteDialogHint: '선택한 {count}개 페이지를 삭제하시겠습니까? 되돌릴 수 없습니다.',
      bulkDeleteConfirm: '삭제',
      bulkDeleteSuccess: '{count}개 페이지를 삭제했습니다',
      ...
      bulkJobUndoing: '실행 취소 중…',
      bulkJobUndoSucceeded: '실행 취소됨',
      ...
      batch: {
        error: {
          notFound: '페이지가 존재하지 않거나 삭제되었습니다',
          folderNotFound: '대상 폴더가 존재하지 않습니다',
          folderConflict: '폴더 이름 충돌',
          folderNotEmpty: '대상 폴더가 비어 있지 않습니다',
          kbMismatch: '페이지가 현재 지식베이스에 속하지 않습니다',
          internal: '서버 내부 오류',
        },
        // Build #14 — wiki 일괄 작업 감사 로그 UI
        audit: {
          toolbarBtn: '감사 로그',
          jobDrawerTitle: '작업 {id} 감사 기록',
          kbDrawerTitle: '일괄 작업 감사 로그',
          empty: '감사 기록이 없습니다',
          filterAction: '이벤트별 필터',
          filterActor: '작업자별 필터',
          export: 'CSV 내보내기',
          exportFailed: '내보내기 실패. 잠시 후 다시 시도해 주세요.',
          action: {
            enqueue: '대기열에 추가됨',
            start: '실행 시작',
            finish: '실행 완료',
            undo_request: '실행 취소 요청',
            undo_done: '실행 취소 완료',
            cancel: '취소됨',
            expire: '만료됨',
          },
  ...
  agent: {
    library: {
      title: 'Agent 라이브러리',
      subtitle: '이 작업 영역의 모든 내장 및 사용자 정의 Agent 탐색',
      countLabel: '개의 Agent',
      filterPlaceholder: 'Agent 이름 / 설명 / 작성자 검색…',
      filterByType: '유형별 필터',
      filterByMode: '모드별 필터',
      filterBySource: '출처별 필터',
      modeQuickAnswer: '빠른 답변',
      modeSmartReasoning: '지능형 추론',
      sourceBuiltin: '내장',
      sourceCustom: '사용자 정의',
      badgeBuiltin: '내장',
      metaTools: '도구 {count}개',
      metaKbAll: '전체 KB',
      metaKbNone: 'KB 없음',
      metaKbOne: 'KB 1개',
      metaKbMany: 'KB {count}개',
      startSession: '세션 시작',
      edit: '편집',
      copy: '복사',
      emptyTitle: '이 작업 영역에 아직 Agent가 없습니다',
      emptyDesc: '새 Agent를 만들거나 템플릿에서 시작하면 여기에 자동으로 표시됩니다.',
      noMatchTitle: '일치하는 Agent가 없습니다',
      noMatchDesc: '다른 검색어를 시도하거나 필터를 지워보세요.',
    },
    taskLabel: '작업:',
    think: '사고',
  ...
  knowledgeStages: {
    ...
    justNow: '방금',
    secondsAgo: '{n}초 전',
    minutesAgo: '{n}분 전',    hoursAgo: '{n}시간 전',
    daysAgo: '{n}일 전',
  ...
  wiki: {
    ...
    tags: {
      ...
      deleteSuccess: '태그가 삭제되었습니다',
      add: '태그 추가',
      remove: '제거',
      selectPlaceholder: '태그 검색…',
      empty: '아직 태그가 없습니다 — 위 버튼으로 만드세요',
      emptyHint: '태그는 페이지를 묶어 일괄 작업을 한 번에 처리할 수 있게 합니다',
      pageEmpty: '이 페이지에는 태그가 없습니다',
      bulkBar: '{count}개 페이지 선택됨 — 태그 추가/제거',
      bulkSelectTag: '태그 선택',
      bulkAdd: '일괄 추가',
      bulkRemove: '일괄 제거',
      bulkNoTags: '먼저 사이드바에서 태그를 만드세요',
      bulkAddSuccess: '태그가 일괄 추가되었습니다',
      bulkRemoveSuccess: '태그가 일괄 제거되었습니다',
      bulkPartial: '일부 페이지 처리 실패',
      dialog: {
        createTitle: '새 태그',
        editTitle: '태그 편집 · {name}',
        nameLabel: '이름',
        namePlaceholder: '예: todo / arch / wip',
        colorLabel: '색상',
        save: '저장',
        cancel: '취소',
        createSuccess: '태그가 생성되었습니다',
        updateSuccess: '태그가 업데이트되었습니다',
      },
      error: {
        nameEmpty: '이름은 비워둘 수 없습니다',
        nameTooLong: '이름은 64자 이하여야 합니다',
        limitReached: '페이지당 최대 10개의 태그를 가질 수 있습니다',
        selectFirst: '먼저 태그를 선택하세요',
        createFailed: '태그 생성 실패',
        updateFailed: '태그 업데이트 실패',
        deleteFailed: '태그 삭제 실패',
        saveFailed: '저장 실패 · {detail}',
        batchFailed: '일괄 작업 실패 · {detail}',
      },
    },
    template: {
      toolbarBtn: '템플릿 스켈레톤 적용',
      title: '템플릿 스켈레톤 적용 · {parent}',
      hint: 'child_pages, child_section, tagged_pages:foo 형태의 자리표시자는 적용 시 자동으로 펼쳐집니다. 구체적인 내용을 입력한 후 적용하세요.',
      children: '하위 페이지',
      addChild: '하위 페이지 추가',
      noChildren: '아직 하위 페이지가 없습니다',
      sections: '하위 섹션',
      addSection: '하위 섹션 추가',
      noSections: '아직 하위 섹션이 없습니다',
      childTitle: '하위 페이지 제목',
      childContent: '하위 페이지 본문(선택)',
      sectionTitle: '섹션 제목',
      sectionBody: '섹션 본문',
      taggedTokens: '태그된 페이지',
      taggedTokensPlaceholder: 'tag1, tag2, ...',
      taggedTokensHint: '쉼표/공백/줄바꿈으로 구분된 태그 이름. tagged_pages:foo 형태의 자리표시자가 각 태그의 페이지 목록으로 펼쳐집니다.',
      preview: '펼쳐진 본문 미리보기',
      previewButton: '미리보기',
      previewEmpty: '적용하기 전에 미리보기를 클릭하여 펼쳐진 본문을 확인하세요.',
      previewOk: '미리보기 생성됨',
