export default {
  ...
  datasource: {
    ...
    connector: {
      ...
      namePlaceholder: 'Имя коннектора, напр. slack-prod',
      configPlaceholder: 'JSON-конфигурация коннектора',
      kbIdPlaceholder: 'ID целевой базы знаний',
      cancel: 'Отмена',
      submit: 'Создать',
      noConnectors: 'Коннекторов пока нет. Нажмите «Новый коннектор», чтобы добавить.',
      enabled: 'включён',
      disabled: 'отключён',
      lastSync: 'Последняя синхронизация',
      syncNow: 'Синхронизировать сейчас',
      delete: 'Удалить',
      lastJob: 'Последнее задание синхронизации',
      ingested: 'Импортировано',
      lastError: 'Последняя ошибка',
      confirmDelete: 'Удалить коннектор «{name}»? Это действие необратимо.',
      kinds: {
        slack: 'Slack',
        email: 'Email',
        webhook: 'Webhook',
  ...
  tenant: {
    ...
    retry: 'Повторить',
    unknown: 'Неизвестно',
    tooltipWithRole: 'Активное рабочее пространство: {tenant} · Роль: {role} (нажмите для переключения)',
    tooltipNoRole: 'Активное рабочее пространство: {tenant} (нажмите для переключения)',
  ...
  knowledgeEditor: {
    ...
    wikiInlineAI: {
      regionLabel: 'Встроенные действия ИИ',
      summarize: 'Сводка',
      summarizeTitle: 'Сводка выделенного с помощью ИИ',
      translate: 'Перевести',
      translateTitle: 'Перевести выделенное с помощью ИИ',
      explain: 'Объяснить',
      explainTitle: 'Объяснить выделенное с помощью ИИ',
      improve: 'Улучшить',
      improveTitle: 'Улучшить выделенное с помощью ИИ',
      ask: 'Спросить',
    ...
    wikiDatabaseView: {
      ...
      filterPlaceholder: 'Поиск по названию / описанию / свойствам…',
      typeFilter: 'Фильтр по типу',
      emptyTitle: 'В этой базе знаний пока нет страниц',
      emptyDesc: 'Страницы появятся здесь автоматически после создания или импорта документов.',
      noMatchTitle: 'Подходящих страниц не найдено',
      noMatchDesc: 'Попробуйте другой поисковый запрос или сбросьте фильтры.',
      viewTable: 'Таблица',
      viewBoard: 'Доска',
      boardGroupBy: 'Группировать по',
      boardGroupByPlaceholder: 'Выберите свойство',
      boardEmpty: 'В текущем наборе страниц нет свойств, доступных для группировки.',
      boardColEmpty: 'Пусто',
      boardUngrouped: 'Без группы',
          viewCalendar: 'Календарь',
      calendarDateLabel: 'Поле даты:',
      calendarDatePlaceholder: 'Выберите свойство даты',
      calendarEmpty: 'Выберите свойство даты выше, чтобы заполнить календарь.',
      calendarMore: 'ещё',
    },
    ...
    wikiBrowser: {
      ...
      newPageTemplateLabel: 'Шаблон страницы',
      newPageTemplateBlank: 'Пустая страница',
      newPageTemplateMeeting: 'Протокол встречи',
      newPageTemplateWeekly: 'Еженедельный отчёт',
      newPageTemplateManage: 'Управление шаблонами',
      userTemplate: {
        title: 'Пользовательские шаблоны',
        listTitle: 'Мои шаблоны',
        empty: 'Шаблонов пока нет. Нажмите «Создать», чтобы добавить.',
        addBtn: 'Создать',
        addTitle: 'Новый пользовательский шаблон',
        editTitle: 'Изменить пользовательский шаблон',
        nameLabel: 'Название шаблона',
        namePlaceholder: 'напр. Заметки о визите клиента',
        nameRequired: 'Укажите название шаблона',
        contentLabel: 'Тело шаблона (Markdown)',
        contentPlaceholder: 'Markdown-тело шаблона; можно использовать плейсхолдеры',
        createSuccess: 'Шаблон создан',
        updateSuccess: 'Шаблон обновлён',
        deleteTitle: 'Удалить шаблон',
        deleteConfirm: 'Удалить шаблон «{name}»? Действие необратимо.',
        deleteSuccess: 'Шаблон удалён',
        sectionTitle: 'Мои шаблоны',
      },
      commentsBtn: 'Комментарии',
      comments: {
        title: 'Комментарии к странице',
        titleFor: 'Комментарии к «{title}»',
        hint: 'Используйте {\'@\'} для упоминания коллег — список кандидатов появится автоматически. Комментарии сохраняются вместе с версиями страницы.',
        empty: 'Пока нет комментариев — оставьте первый.',
        submit: 'Отправить',
        placeholder: 'Поделитесь мыслями или вопросами…',
        createSuccess: 'Комментарий опубликован',
        updateSuccess: 'Комментарий обновлён',
        deleteTitle: 'Удалить комментарий',
        deleteConfirm: 'Удалить комментарий пользователя {author}?',
        deleteSuccess: 'Комментарий удалён',
        editBtn: 'Изменить',
        error: {
          empty: 'Текст комментария не может быть пустым',
          tooLong: 'Комментарий превышает лимит в 4096 символов',
          loadFailed: 'Не удалось загрузить комментарии',
          createFailed: 'Не удалось опубликовать комментарий',
          updateFailed: 'Не удалось обновить комментарий',
          deleteFailed: 'Не удалось удалить комментарий',
        },
        mention: {
          loading: 'Поиск…',
          empty: 'Подходящих пользователей нет',
        },
      },
      shareBtn: 'Поделиться',
      share: {
        header: 'Поделиться страницей',
        headerFor: 'Поделиться «{title}»',
        createTitle: 'Создать новую ссылку',
        ...
        expiryNeverLabel: 'Бессрочно',
        expiryRevoked: 'Отозвана',
        expiryExpired: 'Истекла',
        expiresAt: 'Истекает {at}',
        passwordLabel: 'Пароль (необязательно)',
        passwordPlaceholder: 'Оставьте пустым, если пароль не нужен',
        passwordChip: 'Пароль',
        passwordTitle: 'Ссылка защищена паролем',
        passwordHint: 'Введите пароль, установленный владельцем',
        passwordUnlock: 'Разблокировать',
        passwordWrong: 'Неверный пароль',
        passwordUnlockFailed: 'Не удалось разблокировать',
        watermarkHint: 'При открытии на страницу накладывается водяной знак, позволяющий отследить скриншоты.',
        createBtn: 'Создать ссылку',
        createSuccess: 'Ссылка создана и скопирована',
        empty: 'Ссылок для публикации пока нет',
        copyBtn: 'Копировать',
        copySuccess: 'Ссылка скопирована',
        copyFallback: 'Скопируйте эту ссылку вручную',
        revokeBtn: 'Отозвать',
        revokeTitle: 'Отозвать ссылку',
        revokeConfirm: 'Ссылка перестанет работать немедленно. Продолжить?',
        revokeSuccess: 'Ссылка отозвана',
        views: '{count} просмотров',
        lastViewed: 'Последний просмотр {at}',
        publicSubtitle: 'Публичная ссылка',
        publicSubtitleFor: 'Из {kb}',
        publicFooter: 'Обновлено: {when} · Тип: {type}',
        publicFooterRaw: 'Обновлено: {when} · Тип: {type}',
        errorLoadTitle: 'Не удалось загрузить',
        errorLoadBody: 'Повторите попытку позже',
        errorRevokedTitle: 'Ссылка отозвана',
        errorRevokedBody: 'Владелец отозвал эту ссылку',
        errorNotFoundTitle: 'Ссылка не найдена',
        errorNotFoundBody: 'Возможно, ссылка удалена или никогда не существовала',
        error: {
          loadFailed: 'Не удалось загрузить ссылки',
          createFailed: 'Не удалось создать ссылку',
          revokeFailed: 'Не удалось отозвать ссылку',
        },
      },
      aclBtn: 'Права',
      aclReadOnlyHint: 'Только просмотр',
      aclBannerPrivate: 'Эта страница приватна — её видит только автор и администраторы',
      aclBannerAllowList: 'Эта страница доступна только {count} указанным участникам',
      backlinks: {
        title: 'Обратные ссылки',
        count: '{n}',
        empty: 'Обратных ссылок нет',
      ...
      acl: {
        ...
        modeTitle: 'Режим доступа',
        mode: {
          inherit: 'Наследовать от базы знаний',
          inheritHint: 'По умолчанию — следует правилам уровня БЗ',
          private: 'Приватная',
          privateHint: 'Только автор страницы и администраторы тенанта',
          allowList: 'Список разрешённых',
          allowListHint: 'Помимо членов БЗ, разрешить указанным участникам',
        },
        allowListTitle: 'Разрешённые участники',
        searchPlaceholder: 'Поиск по имени или email для добавления',
        searching: 'Поиск…',
        searchEmpty: 'Подходящих пользователей нет',
        allowListEmpty: 'Никто пока не добавлен',
        denyInherited: 'Скрыть страницу от членов БЗ, которых нет в списке',
        removeAria: 'Удалить {name}',
        saveSuccess: 'Права сохранены',
        updatedAt: 'Обновлено {time}',
        error: {
          loadFailed: 'Не удалось загрузить настройки прав',
          saveFailed: 'Не удалось сохранить настройки прав',
          conflict: 'Права страницы были изменены другим пользователем — обновлено до актуальной версии',
          network: 'Ошибка сети, повторите попытку',
          denied: 'У вас нет прав изменять настройки этой страницы',
          generic: 'Не удалось сохранить, повторите попытку позже',
        },
      },
      ...
      revisionsDrawer: {
        ...
        empty: 'История версий пуста — снимок создаётся автоматически при изменении страницы.',
        ...
        selectToCompare: 'Добавить к сравнению',
        clearCompare: 'Очистить сравнение',
        compareSummary: '+{added} − {deleted}',
        diffTruncated: 'Содержимое слишком большое — сравнение не отображается. Откройте версии по одной.',
        noContent: 'У этой версии нет содержимого',
        revert: 'Откатить к этой версии',
        revertConfirmTitle: 'Подтверждение отката',
        revertConfirm: 'Откатить страницу к v{version}? Текущее содержимое будет сначала сохранено как новая версия, и сам откат тоже можно отменить.',
        revertSuccess: 'Откат к v{version} выполнен',
        revertError: 'Не удалось откатить',
      },
      // Build #12 — массовые операции wiki-страниц i18n ключи
      bulkSelect: 'Выбрать',
      bulkBar: 'Выбрано: {count}',
      bulkMove: 'Переместить',
      bulkMoveDialogTitle: 'Переместить страницы',
      bulkMoveDialogHint: 'Выберите папку назначения. Все {count} выбранных страниц будут перемещены в неё.',
      bulkMoveSelectFolder: 'Выберите папку',
      bulkMoveConfirm: 'Переместить',
      bulkMoveSuccess: 'Перемещено страниц: {count}',
      bulkMovePartial: 'Успешно: {succeeded}, ошибок: {failed}',
      bulkMoveFailed: 'Сбой массового перемещения: {error}',
      bulkMoveLoadFoldersFailed: 'Не удалось загрузить папки',
      bulkStatus: 'Статус',
      bulkStatusSuccess: 'Статус обновлён у {count} страниц',
      bulkStatusPartial: 'Успешно: {succeeded}, ошибок: {failed}',
      bulkStatusFailed: 'Сбой массового обновления статуса: {error}',
      bulkDelete: 'Удалить',
      bulkDeleteDialogTitle: 'Удалить страницы',
      bulkDeleteDialogHint: 'Удалить выбранные {count} страниц? Это действие необратимо.',
      bulkDeleteConfirm: 'Удалить',
      bulkDeleteSuccess: 'Удалено страниц: {count}',
      ...
      bulkJobUndoing: 'Отмена…',
      bulkJobUndoSucceeded: 'Отменено',
      ...
      batch: {
        error: {
          notFound: 'Страница не найдена или удалена',
          folderNotFound: 'Целевая папка не найдена',
          folderConflict: 'Конфликт имени папки',
          folderNotEmpty: 'Целевая папка не пуста',
          kbMismatch: 'Страница не принадлежит этой базе знаний',
          internal: 'Внутренняя ошибка сервера',
        },
        // Build #14 — журнал аудита пакетных операций Wiki
        audit: {
          toolbarBtn: 'Журнал аудита',
          jobDrawerTitle: 'История задачи {id}',
          kbDrawerTitle: 'Журнал пакетных операций',
          empty: 'Записей пока нет',
          filterAction: 'Фильтр по событию',
          filterActor: 'Фильтр по исполнителю',
          export: 'Экспорт CSV',
          exportFailed: 'Не удалось экспортировать. Попробуйте позже.',
          action: {
            enqueue: 'Поставлено в очередь',
            start: 'Запущено',
            finish: 'Завершено',
            undo_request: 'Запрошена отмена',
  ...
  agent: {
    library: {
      ...
      subtitle: 'Просмотр всех встроенных и пользовательских агентов в этом рабочем пространстве',
      countLabel: 'агентов',
      filterPlaceholder: 'Поиск по имени / описанию / создателю…',
      filterByType: 'Фильтр по типу',
      filterByMode: 'Фильтр по режиму',
      filterBySource: 'Фильтр по источнику',
      modeQuickAnswer: 'Быстрый ответ',
      modeSmartReasoning: 'Умное рассуждение',
      sourceBuiltin: 'Встроенный',
      sourceCustom: 'Пользовательский',
      badgeBuiltin: 'Встроенный',
      metaTools: '{count} инструментов',
      metaKbAll: 'Все KB',
      metaKbNone: 'Без KB',
      metaKbOne: '1 KB',
      metaKbMany: '{count} KB',
      ...
      edit: 'Редактировать',
      copy: 'Копировать',
      emptyTitle: 'В этом рабочем пространстве пока нет агентов',
      emptyDesc: 'Создайте нового агента или начните с шаблона — они появятся здесь автоматически.',
      noMatchTitle: 'Подходящих агентов не найдено',
      noMatchDesc: 'Попробуйте другой поисковый запрос или сбросьте фильтры.',
    },
    taskLabel: 'Задача:',
    think: 'Размышление',
  ...
  knowledgeStages: {
    ...
    justNow: 'just now',
    secondsAgo: '{n}s ago',
    minutesAgo: '{n}m ago',    hoursAgo: '{n} ч назад',
    daysAgo: '{n} дн назад',
  ...
  wiki: {
    ...
    tags: {
      ...
      add: 'Добавить тег',
      remove: 'Убрать',
      selectPlaceholder: 'Поиск тегов…',
      empty: 'Тегов пока нет — создайте его кнопкой выше',
      emptyHint: 'Теги объединяют страницы, чтобы массовые операции применялись сразу',
      pageEmpty: 'У этой страницы нет тегов',
      bulkBar: 'Выбрано {count} стр. — добавить или убрать тег',
      bulkSelectTag: 'Выберите тег',
      bulkAdd: 'Массовое добавление',
      bulkRemove: 'Массовое удаление',
      bulkNoTags: 'Сначала создайте теги в боковой панели',
      bulkAddSuccess: 'Тег добавлен массово',
      bulkRemoveSuccess: 'Тег удалён массово',
      bulkPartial: 'Часть страниц не обработана',
      dialog: {
        createTitle: 'Новый тег',
        editTitle: 'Изменить тег · {name}',
        nameLabel: 'Название',
        namePlaceholder: 'напр.: todo / arch / wip',
        colorLabel: 'Цвет',
        save: 'Сохранить',
        cancel: 'Отмена',
        createSuccess: 'Тег создан',
        updateSuccess: 'Тег обновлён',
      },
      error: {
        nameEmpty: 'Название не может быть пустым',
        nameTooLong: 'Название должно быть не длиннее 64 символов',
        limitReached: 'На странице может быть не более 10 тегов',
        selectFirst: 'Сначала выберите тег',
        createFailed: 'Не удалось создать тег',
        updateFailed: 'Не удалось обновить тег',
        deleteFailed: 'Не удалось удалить тег',
        saveFailed: 'Сохранение не выполнено · {detail}',
        batchFailed: 'Массовая операция не выполнена · {detail}',
      },
    },
    template: {
      toolbarBtn: 'Применить скелет шаблона',
      title: 'Применить скелет шаблона · {parent}',
      hint: 'Заполнители вида child_pages, child_section, tagged_pages:foo будут раскрыты при применении. Заполните конкретное содержимое перед применением.',
      children: 'Дочерние страницы',
      addChild: 'Добавить дочернюю страницу',
      noChildren: 'Дочерние страницы ещё не добавлены',
      sections: 'Дочерние разделы',
      addSection: 'Добавить раздел',
      noSections: 'Дочерние разделы ещё не добавлены',
      childTitle: 'Заголовок дочерней страницы',
      childContent: 'Тело дочерней страницы (необязательно)',
      sectionTitle: 'Заголовок раздела',
      sectionBody: 'Тело раздела',
      taggedTokens: 'Страницы с тегами',
      taggedTokensPlaceholder: 'tag1, tag2, ...',
      taggedTokensHint: 'Имена тегов, разделённые запятой/пробелом/переводом строки. Заполнители вида tagged_pages:foo раскрываются в список страниц для каждого тега.',
      preview: 'Предпросмотр раскрытого тела',
      previewButton: 'Предпросмотр',
      previewEmpty: 'Нажмите «Предпросмотр», чтобы увидеть раскрытое тело перед применением.',
      previewOk: 'Предпросмотр создан',
