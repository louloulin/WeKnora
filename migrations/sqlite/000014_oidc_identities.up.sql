...
ALTER TABLE users ADD COLUMN oidc_managed_system_admin BOOLEAN NOT NULL DEFAULT 0;
CREATE INDEX IF NOT EXISTS idx_users_oidc_managed_system_admin ON users(oidc_managed_system_admin);
ALTER TABLE tenant_members ADD COLUMN role_source VARCHAR(20) NOT NULL DEFAULT 'local';
